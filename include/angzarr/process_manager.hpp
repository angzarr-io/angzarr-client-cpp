...
class ProcessManager {
 public:
  ...
  using EventApplier = std::function<void(ProcessManager*, StateT&,
   ...
   */
  /**
   * Result from PM dispatch - commands for normal events, or rejection
   * response.
   */
 ...
 protected:
   ...
   */
  template <typename T>
  std::vector<CommandBook> pack_commands(const T& command,
   ...
   */
  static void register_event_handler(const std::string& suffix,
 ...
 private:
  ...
  RejectionHandlerResponse dispatch_rejection(
